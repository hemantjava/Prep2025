package com.prep.interview.stream.student;
...
public class Main {
    public static void main(String[] args) {
        ...
        students.stream().sorted(Comparator.comparing(StudentDTO::getAge,Comparator.reverseOrder())
                .thenComparing(StudentDTO::getName,Comparator.reverseOrder()))
